...
extension ViewController {
    func updateBeaconZoneViews(beaconIdentifiersInRange identifiersInRange: [String]) {
    ...
    func addBeaconZoneViews(colorByBeaconIdentifier: [String: UIColor]) {
        for identifier in colorByBeaconIdentifier.keys {
            ...
            identifierLabel.setContentHuggingPriority(UILayoutPriorityRequired, for: .vertical)
            identifierLabel.setContentCompressionResistancePriority(UILayoutPriorityRequired, for: .vertical)
